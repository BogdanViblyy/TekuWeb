        ...
        <div className="flex items-center justify-center min-h-screen pt-[var(--header-total-height)] pb-12 bg-gray-50">
            <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
                ...
                <form action={formAction} className="space-y-4">
                    <div>
                        <label htmlFor="name" className="block text-sm font-medium text-gray-700">{tAuth('username')}</label>
                    ...
                    <div>
                        <label htmlFor="email" className="block text-sm font-medium text-gray-700">{tAuth('email')}</label>
                    ...
                    <SubmitButton text={tAuth('registerButton')} loadingText={tAuth('registering')} />
                </form>
